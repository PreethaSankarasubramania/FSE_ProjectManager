...
@Component({
  selector: 'app-list-project-component',
  templateUrl: './list-project-component.component.html',
  styleUrls: ['./list-project-component.component.css']
})
export class ListProjectComponentComponent implements OnInit {
